...
- [ ] G6 - Eight LEDs and accent/grouping patterns
- [ ] G7 - EEPROM presets
- [ ] G8 - Experimental microphone tap detection
- [ ] G9 - MIDI Clock

G0 through G4 are implemented. G4 adds D6 Start/Stop and D7 Tap Tempo while
retaining G2's fixed four-LED 4/4 sequence.
